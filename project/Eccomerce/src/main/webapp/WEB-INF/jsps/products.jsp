                                 ...
                                 <br>
									<form class="forms-sample">
										<div class="form-group">
											<form:label for="exampleInputName1" path="productName">Product Name</form:label>
											<form:input type="text" class="form-control"
												id="exampleInputName1" placeholder=" Product Name" path="productName"></form:input>
										</div>
										<div class="form-group">
											<form:label for="exampleInputName1" path="productQuantity">Product Quantity</form:label>
											<form:input type="text" class="form-control"
												id="exampleInputName1" placeholder="Product Quantity" path="productQuantity"></form:input>
										</div>
										<div class="form-group">
												<form:label for="exampleInputName1" path="productPrice">Product Price</form:label>
											<form:input type="text" class="form-control"
												id="exampleInputName1" placeholder="Product Price" path="productPrice"></form:input>
										</div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                        <c:forEach items="${products }" var="dt">
                          <tr>
                          <td>${dt.getProductName() }</td>
                          <td>${dt.getproductQuantity() }</td>
                          <td>${dt.getProductPrice() }</td>
                          <td><a href="delete?pid=${dt.getProductId()}"></a></td>
                          </tr>
                          </c:forEach>
