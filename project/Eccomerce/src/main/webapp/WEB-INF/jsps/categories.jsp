                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tr>
                          <td>${dt.getCategoryId()}</td>
                           <td>${dt.getCategoryName()}</td>
                            <td><a href="delete?cid=${dt.getCategoryId()}" class="btn btn-danger">Delete</a></td>
                            <td><a href="edit?cid=${dt.getCategoryId()}" class="btn btn-primary">Edit</a></td>
                          </tr>
                          </c:forEach>
                        </tbody>
                      </table>
